...
define(['jquery',"angular","angular-ui-router","ng-grid",'angular-animate'],function ($,angular) {
    ...
    ruleCtrlMod.controller("myRule", ['$scope',function ($scope) {
        $scope.rules=[
...
//         };
    ...
    ruleCtrlMod.controller("myGold", ['$scope',function ($scope) {
...
//            设置当前页的默认值
    ...
    ruleCtrlMod.controller("mySider", ['$scope','$rootScope','$stateParams',function ($scope,$rootScope,$stateParams) {
        ...
        $scope.cc=function (i) {
            ...
            $scope.urlM=$('.list-group-item').children().eq(i).attr('ui-sref');
            console.log($scope.urlM)
        };
...
//    }
        ...
        return {
            ...
            controller:function ($scope,$element,$attrs,$state) {
                $element.on("click",function () {
                    ...
                    $state.go('two',{ruleGroup:$attrs['name']});

                });
                $element.on("mouseleave",function () {

                    $element.css("width","22%");
    ...
    ruleCtrlMod.factory('getDatas',function ($http) {
