...
define(['jquery',"angular","angular-ui-router","ng-grid",'angular-animate'],function ($,angular) {
    ...
    ruleCtrlMod.controller("gridCtrl", ['$scope','$http','$stateParams',function ($scope,$http,$stateParams) {
    ...
    ruleCtrlMod.controller("gridCtrl2", ['$scope','$http','$stateParams','$rootScope',function ($scope,$http,$stateParams,$rootScope) {
        ...
        $scope.users=$rootScope.zongRule
        // $scope.users=[
        //     {"id":"1", "type":"房贷", "time":"2016-11-10 11:49:28", "name":"廖蓉蓉", "id_card":"456546345631514", "autoCheck": "未审核", "rule":"0", "company":"滴滴", "personCheck":"未审核", "checkPeople":"张三", "report":"查看", "play":"删除"
        //     }, {"id":"2", "type":"房贷", "time":"2016-11-10 11:49:28", "name":"廖蓉蓉", "id_card":"456546345631514", "autoCheck": "未审核", "rule":"0", "company":"滴滴", "personCheck":"未审核", "checkPeople":"张三", "report":"查看", "play":"删除"
        //     }, {"id":"3", "type":"房贷", "time":"2016-11-10 11:49:28", "name":"廖蓉蓉", "id_card":"456546345631514", "autoCheck": "未审核", "rule":"0", "company":"滴滴", "personCheck":"未审核", "checkPeople":"张三", "report":"查看", "play":"删除"}, {"id":"4", "type":"房贷", "time":"2016-11-10 11:49:28", "name":"廖蓉蓉", "id_card":"456546345631514", "autoCheck": "未审核", "rule":"0", "company":"滴滴", "personCheck":"未审核", "checkPeople":"张三", "report":"查看", "play":"删除"
    ...
    ruleCtrlMod.controller("myUser", ['$scope','$rootScope','$stateParams','$http',function ($scope,$rootScope,$stateParams,$http) {
        //小put框增加按钮的盒子
        ...
        //小put框中的保存按钮
        $http.get('./data/ruleList'+aa+'.json').success(function (data) {
            ...
            $rootScope.zongRule=$scope.fraudGroups.concat($scope.creditGroups);
    ...
    ruleCtrlMod.controller("myGold", ['$scope','$state',function ($scope,$state) {
...
//            设置当前页的默认值
    ...
    ruleCtrlMod.controller("mySider", ['$scope','$rootScope','$stateParams',function ($scope,$rootScope,$stateParams) {}]);    ruleCtrlMod.factory('myFactory',[myFactory]);
    function myFactory() {
        var list={};
        return{
              get:function (id) {
